...
<template xmlns="http://www.w3.org/1999/html">
  <main id="page-title_nav__layout">
    <main id="page-title_nav_layout__back">
      <h1>{{ title }}</h1>
      <a href="/">
        <main id="back">
          <svg
  ...
  <main v-if="img">
    ...
    <ul class="info">
      <p id="fontSize">滑动图片以阅读</p>
      <p id="fontSizePC">SHIFT + 鼠标滚轮滑动</p>
      <p>
        <a :href="url" target="_blank">
          <svg
