...
<!--        日历及导航-->
      ...
      <div class="column is-two-thirds body-content-layout">
        ...
        <div class="body-con-main">
          <ul class="body-con-main_title">
            <li class="body-con-main_title__top"></li>
            <li style="color: #000000;font-weight: bold">江雪联合实验室銮音项目</li>
            <li>client-side</li>
            <li>2023.12.25</li>
          </ul>
          <div class="body-con-main__img" style="background: center no-repeat url('https://github.com/iepn/why-up-down/assets/57232813/ca9a3701-a287-44bb-8c42-266acf43dc67')"></div>
          <a href="#">https://secgay.test.luanyin.jiangxue.org/</a>
          <p>BY: RHYME.Q</p>
        </div>
        <div class="body-con-main">
          <ul class="body-con-main_title">
