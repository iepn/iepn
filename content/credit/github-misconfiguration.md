...
"description": ""
"platform": "/images/credit/logo/hackerone.png"
"director": "RHYME.Q"
"types": "CREDIT"
"vulnerability": "CWE-16"
"release_date": 2023.12.04
"demo": "https://hackerone.com/iepn"
...
这是我第一次提交漏洞获得赏金和周边奖励的漏洞，所以我印象深刻。自我放弃安全路线以来，再一次发现较为知名厂商或平台的安全缺陷，可以当做是我的里程碑，但并不是终点。
...
::text-space
---
info: 从笔记本电脑上的贴花和衣服上的图形，到每个酒吧墙上、电线杆和街道标志上贴的贴纸，GitHub 的吉祥物 Octocat 是科技行业最知名的符号之一。@Cameron McEfee
---
::
...
---
img: 7/1
info: 我很幸运在他们立项后的 13 年后，获得了它们的实体周边贴纸和胸针。他们的设计师是 @KimEstoesta 和 @Cameron McEfee
---
::

同时我还收获到了来自 Github Bug Bounty 的 $200 USD ≈ 1,439 CNY 漏洞赏金，是我在安全道路中，第一次获得如此高昂的现金奖励。

可惜我的定位一直就是团队中的 ACD（辅助）成长缓慢容易给单杀 0_0，一直处于打酱油的状态，有很多方面的技能树需要提升。

自意识到安全是基于开发之下的存在后，我便开始尝试慢慢往开发方面转型，曾经我的老师之前说过：“如果真的有天赋，那不应该将时间投入到应用和框架当中，应该聚焦原理和底层逻辑的设计”。
...
因此我一生中最敬佩的只有两种人，一种是追求这种境界成功的。而另一种是没有追求这种境界的，一直停留在最开始的阶段。
